                    ...
                    <div className="col-start-2 col-span-10">
                        ...
                        {activePanel === 'checkbox' && (
                            <XPanel
                                header="Checkbox"
                            >
                                <div className="card flex items-center justify-content-center gap-2">
                                    <XCheckbox onChange={e => setChecked(e.checked)} checked={checked}></XCheckbox>
                                    <XCheckbox inputId="check4" name="pizza" onChange={e => setCheckedDisabled(e.checked)} checked={checkedDisabled} value="Cheese" disabled />
                                    <label htmlFor="check4"> Cheese </label>
                                </div>
                            </XPanel>
                        )}
