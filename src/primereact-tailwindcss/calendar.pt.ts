...
export const calendarPT = {
    ...
    input: ({ props }) => ({
        root: {
            className: classNames('font-sans text-base text-gray-600 bg-white p-3 border border-gray-300 transition-colors duration-200 appearance-none', 'hover:border-blue-500', {
    ...
    panel: ({ props }) => ({
        className: classNames('bg-white', 'min-w-full', {
            'shadow-md border-0 absolute': !props.inline,
            'inline-block overflow-x-auto border border-gray-300 p-2 rounded-lg': props.inline
        })
    }),
    header: {
        className: classNames('flex items-center justify-between', 'p-2 text-gray-700 bg-white font-semibold m-0 border-b border-gray-300 rounded-t-lg')
    },
    previousButton: {
    ...
    monthTitle: {
        className: classNames('text-gray-700 transition duration-200 font-semibold p-2', 'mr-2', 'hover:text-blue-500')
    },
    yearTitle: {
        className: classNames('text-gray-700 transition duration-200 font-semibold p-2', 'hover:text-blue-500')
    },
    nextButton: {
        className: classNames(
            'flex items-center justify-center cursor-pointer overflow-hidden relative',
