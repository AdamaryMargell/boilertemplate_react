...
export const colorPickerPT = {
    ...
    input: {
        className: classNames(
            'm-0',
            'font-sans text-base text-gray-600 p-3 border border-gray-300 transition-colors duration-200 rounded-lg cursor-pointer',
            'hover:border-blue-500 focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)]',
            'w-8 h-8'
        ),
        style: {} // Se sobrescribirá dinámicamente
    },
    panel: ({ props }) => ({
